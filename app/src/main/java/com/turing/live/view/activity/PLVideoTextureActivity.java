...
import com.turing.live.base.VideoPlayerBaseActivity;
import com.turing.live.utils.Utils;
import com.turing.live.view.fragment.LiveMainDialogFragment;
import com.turing.live.widgets.MediaController;
...
//    private MediaController mMediaController;
    ...
    private String photoPath; //封面Url
    private String xid; //用户ID
...
//        Glide.with(this).load(photoPath).into(mCoverView);
...
//        mVideoView.setMediaController(mMediaController);
        ...
        new LiveMainDialogFragment(xid).show(getSupportFragmentManager(),"LiveMainDialogFragment");
    }
